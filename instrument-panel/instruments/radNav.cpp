...
radNav::radNav(int xPos, int yPos, int size) : instrument(xPos, yPos, size)
{
    setName("Rad Nav");
...
void radNav::resize()
{
    ...
    ALLEGRO_BITMAP* orig = loadBitmap("rad-nav.bmp");
    addBitmap(orig);
