...
Link: [Latest release of Instrument Panel for Windows](https://github.com/scott-vincent/instrument-panel/releases/download/v1.3.3/instrument-panel-v1.3.3-Windows-x64.zip)

Link: [Latest release of Instrument Data Link for Windows](https://github.com/scott-vincent/instrument-data-link/releases/download/v1.3.3/instrument-data-link-v1.3.3-windows-x64.zip)
